...
from models.ours.transformer.swin_transformer import SwinMLP
...
class _Discriminator(nn.Module):
    def __init__(self, in_ch, out_ch):
        ...
        self.c0_0 = CBR(in_ch, 3, bn=False, sample='same', activation=nn.LeakyReLU(0.2, True), dropout=False)
        self.c0_1 = CBR(out_ch, 3, bn=False, sample='same', activation=nn.LeakyReLU(0.2, True), dropout=False)
        self.c1 = CBR(6, 6, bn=True, sample='down', activation=nn.LeakyReLU(0.2, True), dropout=False)
        ...
        self.swin_former = SwinMLP(img_size=224)
